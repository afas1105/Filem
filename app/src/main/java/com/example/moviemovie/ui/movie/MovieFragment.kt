package com.example.moviemovie.ui.movie
...
import com.example.moviemovie.databinding.FragmentMovieBinding
        ...
        adapter.addLoadStateListener { loadState ->
            binding.apply {
                ...
                if (loadState.source.refresh is LoadState.NotLoading && loadState.append.endOfPaginationReached && adapter.itemCount < 1){
                    ...
                    tvNotFaound.isVisible = true
                } else {
                    tvNotFaound.isVisible = false
                }
            }
        }
